...
- 🧹 移除 PROMPTY 标题右侧硬编码版本号，避免与系统状态右侧版本徽章重复
- 🏷️ 页面只保留系统状态旁的 `VersionBadge` 作为唯一版本与更新日志入口

## v3.8.25 (2026-05-15)

### 本次更新

- 📐 OfoxAI 生图渠道补全 `openai/gpt-image-2` 常见高分辨率尺寸，新增 `2048x2048`、`2048x1152`、`3840x2160`、`2160x3840`
- 🧪 更新 OfoxAI 尺寸测试：确认 2K 方图可发送，并保留无效尺寸拦截
